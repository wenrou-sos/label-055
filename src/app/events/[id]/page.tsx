...
function StatusControl({
  ...
  const statuses: { value: EventStatus; label: string; color: string }[] = [
    { value: EventStatus.REGISTRATION_OPEN, label: '报名中', color: 'bg-green-500 hover:bg-green-600' },
    { value: EventStatus.REGISTRATION_CLOSED, label: '报名截止', color: 'bg-gray-500 hover:bg-gray-600' },
    { value: EventStatus.IN_PROGRESS, label: '进行中', color: 'bg-blue-500 hover:bg-blue-600' },
    { value: EventStatus.COMPLETED, label: '已结束', color: 'bg-purple-500 hover:bg-purple-600' },
  ]
